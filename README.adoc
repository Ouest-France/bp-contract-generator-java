...
<dependency>
    <groupId>fr.ouestfrance</groupId>
    <artifactId>bms-bp-contract-generator</artifactId>
...
You might find many other examples in the test directory link:src/test/java/sipa/blockprovider/examples/
